...
public class Beer extends GameObject implements VisibleObject{
	...
	public Beer(double x, double y, double z, double heigth)
	{
		super(x, y, z);
		this.speed = 0.5;
		this.heigth = heigth;
	...
	public void BeerMove(Maze maze)
	{
		 ...
		 * That is separately checked for the X and Z direction. This option is added to the list of states, and
		 * the for loop is stopped.
		 */
